...
//The following code can create an icon with multiple sizes if, for each of the images, 
//the Image.RawFormat is ImageFormat.Png, the Image.PixelFormat is PixelFormat.Format32bppArgb 
